...
json.dump(fund_schemes, open('fund_schemes.json', 'w'))
json.dump({
        "labels_1m" : labels_1m,
        "labels_3m" : labels_3m,
        "labels_6m" : labels_6m,
...
json.dump({
        "normal_scores_1m" : normal_scores_1m,
        "normal_scores_3m" : normal_scores_3m,
        "normal_scores_6m" : normal_scores_6m,
        "normal_scores_1y" : normal_scores_1y,
        "normal_scores_2y" : normal_scores_2y,
        "normal_scores_3y" : normal_scores_3y,
        "normal_scores_5y" : normal_scores_5y,
        }, open('normal_scores.json', 'w'))
#
#
#
# ##
